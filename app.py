...
# EDIT LOGIC (Hidden from menu, triggered by button)
...
if is_admin and st.session_state.edit_id:
    ...
    with st.form("edit_form"):
        ...
        new_desc = st_quill(html=True, defaultValue=curr[3])
        
        st.info("Note: To change images, please delete and re-upload the project.")
...
# VIEW GALLERY
    ...
    for r in rows:
        with st.container():
            ...
            if is_admin:
                if col_edit.button("✏️", key=f"edit_{r[0]}"):
